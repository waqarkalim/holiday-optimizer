  ...
  content: [
    ...
    // Add a custom content pattern to ensure color classes are preserved
    {
      raw: [
        ...
        'bg-(blue|green|amber|emerald|purple|pink|violet|teal|gray|neutral|transparent|slate|zinc|stone|red|orange|yellow|lime|indigo|sky|cyan|fuchsia|rose|black|white|current|today|past)-50',
