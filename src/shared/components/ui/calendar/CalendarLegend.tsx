import { cn, dayTypeToColorScheme, DayType } from '@/shared/lib/utils';
...
export function CalendarLegend({
  ...
  return (
    <div
      className={cn(
        'mb-5 bg-white rounded-lg overflow-hidden',
    ...
    >
      ...
      <div className="p-3">
        <ul
          ...
          className={cn('grid gap-1', 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5')}
        >
