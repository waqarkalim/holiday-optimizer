    ...
    >
      <div className="space-y-4 sm:space-y-5">
        <p className="text-sm leading-relaxed text-blue-900/80">
          Loved your plan? Share it so teammates can unlock smarter stretches of time off too.
        </p>

        <section className="space-y-4 rounded-xl border border-blue-100 bg-blue-50/30 p-4 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:justify-between space-y-3">
            <div className="space-y-0.5">
              <h3 className="text-sm font-semibold text-blue-900">Share in seconds</h3>
              <p className="text-xs text-blue-800/80">
                Send the plan or drop it on socials—whatever gets it out fastest.
              </p>
            </div>
            <a
          ...
          <SocialShareButtons
            ...
            className="flex-wrap gap-2 sm:flex-nowrap"
          />

          <div className="flex flex-col gap-2 rounded-lg border border-blue-100/70 bg-white/85 p-3 sm:flex-row sm:items-center sm:justify-between">
            <span className="text-xs font-medium text-blue-800/80">Quick social drop</span>
            <SocialShareButtons
              variant="secondary"
              title={getShareTitle()}
              description={getShareDescription()}
