...
import { OnboardingStep, useOnboarding } from '@/features/optimizer/context/OnboardingContext';
...
export const useOnboardingOverlay = ({
  ...
  }, [dismissOnboarding, isCurrentStep, isOnboardingVisible, primaryButtonRef, step]);
