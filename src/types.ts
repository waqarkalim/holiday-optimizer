...
export interface TailwindColorStyles {
  bg: string; // Background color classes (e.g., "bg-blue-100")
  text: string; // Text color classes (e.g., "text-blue-600")
  ring: string; // Ring/outline classes (e.g., "ring-blue-400/20")
}
