...
import { Calendar, BarChart, Settings, Clock } from 'lucide-react';
      ...
      <PageContent className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="max-w-4xl mx-auto space-y-10">
          <OptimizationExplainer 
            ...
            factors={[
              { icon: <Calendar className="h-4 w-4 text-blue-600 dark:text-blue-400" />, text: "Available PTO days", bgColor: "bg-blue-100 dark:bg-blue-900/30" },
              { icon: <Calendar className="h-4 w-4 text-violet-600 dark:text-violet-400" />, text: "Public holidays in your region", bgColor: "bg-violet-100 dark:bg-violet-900/30" },
              { icon: <BarChart className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />, text: "Company-specific days off", bgColor: "bg-indigo-100 dark:bg-indigo-900/30" },
              { icon: <Settings className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />, text: "Preferred optimization strategy (long weekends, extended vacations, etc.)", bgColor: "bg-emerald-100 dark:bg-emerald-900/30" }
            ]}
          />
