    ...
    <PageLayout>
      <PageHeader className="bg-gradient-to-b from-teal-50 to-teal-100/30 dark:from-teal-950 dark:to-teal-900/20">
        ...
        <PageDescription className="text-teal-600 dark:text-teal-400">
          Learn how the algorithm helps you maximize your time off
        </PageDescription>
      </PageHeader>

      <PageContent className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="max-w-4xl mx-auto space-y-10">
          <section aria-labelledby="optimization-algorithm-explanation">
            <h2 id="optimization-algorithm-explanation" className="sr-only">Optimization Algorithm Explanation</h2>
            <OptimizationExplainer
              ...
              factorsText="The algorithm analyzes thousands of possible combinations to find the optimal schedule based on your:"
              factors={[
                {
          ...
          <div className="flex justify-center mt-10 mb-6">
            <Link
              ...
              aria-label="Try Holiday Optimizer free tool"
            >
