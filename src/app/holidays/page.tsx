  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900" role="main">
      ...
      <section className="relative overflow-hidden bg-gray-900 text-white">
        <div
          className="absolute inset-0 opacity-20 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-teal-400 via-indigo-500 to-blue-600"></div>
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10 text-center max-w-5xl">
          <div
            className="inline-flex items-center justify-center mb-5 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            <div
              className="inline-flex items-center px-3 py-1.5 bg-white/10 backdrop-blur-sm rounded-full text-sm text-white/80">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <div
                className="w-12 h-12 rounded-full bg-teal-50 dark:bg-teal-900/20 flex items-center justify-center mb-4">
