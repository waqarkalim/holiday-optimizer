const Footer = () => (
  <footer className="bg-gradient-to-t from-white to-gray-50 dark:from-gray-800 dark:to-gray-900/50 border-t border-gray-200 dark:border-gray-700/50">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-8 border-b border-gray-200 dark:border-gray-700/50">
          {/* Left Column - Brand */}
          ...
          <div className="flex flex-col items-start md:items-end space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all
                  text-gray-600 hover:text-gray-900 hover:scale-105 transform
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <svg className="h-4 w-4 text-red-500 dark:text-red-400 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
