...
const OptimizerForm = ({ formState, onFormChange, isOptimizing, error }: OptimizerFormProps) => {
  ...
  return (
    <div className="space-y-8 bg-white dark:bg-gray-800/60 rounded-xl p-6 shadow-sm ring-1 ring-gray-900/5 dark:ring-gray-300/10">
      <div className="space-y-8">
        {/* Number of Days Input */}
        <div>
          <label htmlFor="numberOfDays" className="block text-base font-medium text-gray-900 dark:text-gray-100">
            Number of CTO Days
          </label>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                ...
                className={clsx(
                  ...
                  'disabled:cursor-not-allowed disabled:bg-gray-50 dark:disabled:bg-gray-800/50 disabled:text-gray-500',
                  'placeholder:text-gray-400 dark:placeholder:text-gray-500',
                  errors.numberOfDays && touched.has('numberOfDays')
                    ? 'border-red-300 dark:border-red-700/50 focus:border-red-500 dark:focus:border-red-500'
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {STRATEGIES.map(strategy => (
              <div
                ...
                className={clsx(
                  'relative rounded-lg border p-4 cursor-pointer focus:outline-none transition-colors',
                  formState.strategy === strategy.id
                    ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-700/50 ring-2 ring-blue-500 dark:ring-blue-400'
                    : 'border-gray-200 dark:border-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600/50'
                )}
              >
                <div className="flex items-start">
                  <div className={clsx(
                    'flex-shrink-0 inline-flex p-2 rounded-lg transition-colors',
                    formState.strategy === strategy.id
