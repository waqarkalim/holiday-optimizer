...
const breakTypes = [
  {
    ...
    ariaLabel: 'Long Weekend: 3-4 days off around a weekend'
  },
  {
    name: 'Mini Break',
    icon: CalendarDays,
    ...
    ariaLabel: 'Mini Break: 5-6 days off for a quick getaway'
  },
  {
    name: 'Week Break',
    icon: CalendarRange,
    ...
    ariaLabel: 'Week Break: 7-13 days for a proper vacation'
  },
  {
    name: 'Extended Break',
    icon: Palmtree,
    ...
    ariaLabel: 'Extended Break: 14+ days for an extended holiday'
  },
];
